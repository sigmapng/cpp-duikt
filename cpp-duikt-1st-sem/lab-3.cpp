...
void getScheduleForADay()
{
  ...
  {
  case 1:
    cout << "4. Cross-platform programming" << endl
         << "5. Philosophy" << endl;
    break;
  case 2:
    cout << "2. Foreign Language" << endl
         << "3. Foreign Language" << endl;
    break;
  case 3:
    cout << "1. Maths" << endl
         << "2. Foreign Language" << endl
         << "3. Applied algorithms and data structures"
         << endl
         << "5. C++ Programming" << endl;
    break;
  case 4:
